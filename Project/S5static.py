...
def S5_plot_static(t, whichplot, tsteps, M, S, gamma):
    """
    Plots the interactions of the galaxies in the S5 initial condition at set time values.
    ...
    if whichplot=='direct':
        plt.suptitle('Direct Passage, S5', x=0.5, y=1.02, fontsize=15)
        plt.savefig("directS5.png", bbox_inches='tight')
    else:
        plt.suptitle('Retrograde Passage, S5', x=0.5, y=1.02, fontsize=15)
        plt.savefig("retrogradeS5.png", bbox_inches='tight')
